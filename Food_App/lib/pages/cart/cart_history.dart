...
class CartHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var getCartHistoryList = Get.find<CartController>().getCarHistoryList().reversed.toList();
      ...
      body: Column(
        children: [
          ...
          GetBuilder<CartController>(builder: (_cartController){
            return _cartController.getCarHistoryList().length>0?
            Expanded(
              child: Container(
